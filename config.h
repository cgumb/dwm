...
static const Key keys[] = {
    ...
    STACKKEYS(MODKEY, focus) STACKKEYS(MODKEY | ShiftMask, push){
        ...
        {MODKEY, XK_Insert, spawn,
         SHCMD("xdotool type $(grep -v '^#' ~/.local/share/larbs/snippets | "
               "dmenu "
               "-i -l 50 | cut -d' ' -f1)")},
        ...
        {MODKEY, XK_F11, spawn,
         SHCMD(
             "mpv --untimed --no-cache --no-osc --no-input-default-bindings "
        ...
        /* { 0, XF86XK_PowerOff,		spawn,		{.v = (const
           char*[]){ "sysact", NULL } } }, */
        {0,
         XF86XK_Calculator,
         spawn,
